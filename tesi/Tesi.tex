...
\noindent Nel corso degli esperimenti è sorto un problema utilizzando il solver CVXPY. Con un dataset con poche istanze si è manifestato un problema di convergenza relativo alle librerie ARPACK \cite{ARPACK}, usate da CVXPY per controllare che la matrice inserita sia semidefinita positiva:
