...
Un primo parametro da considerare è quello della scelta della funzione di kernel.
Esistono diversi tipi di funzioni di kernel: quelli principalmente utilizzati sono elencati di seguito.
...
% Piccola Intro
% Specificare Macchina e Dataset Utilizzati
% Librerie Utilizzate e spiegate
\subsection{CVXPY}
\subsection{CVXOPT}
